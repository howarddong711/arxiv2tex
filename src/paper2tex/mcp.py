...
SERVER_INFO = {"name": "paper2tex", "version": "0.1.0"}
...
def main() -> None:
    service = PaperService(Path(".paper-cache"))
    while True:
        try:
